...
(function () {
    ...
    var api = {
        ...
        getActiveTypes: function () {
            ...
            for (var k in activeTypes) {
                if (Object.prototype.hasOwnProperty.call(activeTypes, k)) copy[k] = activeTypes[k];
            }
            return copy;
        },
    ...
    function renderOptions() {
        ...
        for (var i = 0; i < TYPE_ORDER.length; i++) {
            ...
            html += '<label class="filterOption">' +
                '<input type="checkbox" value="' + key + '"' + checked + ' />' +
                '<span class="filterOptionLabel">' + (TYPE_LABELS[key] || key) + '</span>' +
